...
import numpy as np
import logging
from ps3_code.ransac import calculate_num_ransac_iterations, ransac_fundamental_matrix
from ps3_code import two_view_data
from ps3_code import fundamental_matrix
from ps3_code.feature_matching.utils import load_image, PIL_resize
from ps3_code import ransac
...
def test_ransac_find_inliers():
    ...
    common = np.intersect1d(outliers, inliers)
